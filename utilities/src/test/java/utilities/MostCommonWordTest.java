...
public class MostCommonWordTest {
    @Test
    public void repeatedWord_returnsMostCommonWord() {
        ...
        String expected = "the";
        String actual = MostCommonWord.mostCommonWord(testInput);
        assertEquals(expected, actual);
    }
    @Test
    public void repeatedWord_notCaseSensitive() {
        String testInput = "tHe MoSt CoMmOn WorD iN thIs SeNtEnCe iS cOMMoN";
    ...
    public void repeatedWord_returnsNullForEmptyStrings() {
        String testInput = "";
        assertNull(MostCommonWord.mostCommonWord(testInput));
    }
    @Test
